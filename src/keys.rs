...
pub struct KeyConfig {
    ...
    pub commit_new_line: KeyEvent,
    pub apply_commit: KeyEvent,
    pub copy: KeyEvent,
...
impl Default for KeyConfig {
    fn default() -> Self {
        Self {
            ...
            commit_new_line: KeyEvent { code: KeyCode::Enter, modifiers: KeyModifiers::empty()},
            apply_commit: KeyEvent {code: KeyCode::Char('c'), modifiers: KeyModifiers::ALT}, 
