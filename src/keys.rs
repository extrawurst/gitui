...
pub struct KeyConfig {
    ...
    pub open_upstream_branch_popup: KeyEvent,
    pub create_upstream_branch: KeyEvent,
    pub add_remote: KeyEvent,
    pub remove_remote: KeyEvent,
    pub push: KeyEvent,
    pub fetch: KeyEvent,
}
...
impl Default for KeyConfig {
    fn default() -> Self {
        Self {
            ...
            open_upstream_branch_popup: KeyEvent { code: KeyCode::Char('u'), modifiers: KeyModifiers::NONE},
            create_upstream_branch: KeyEvent { code: KeyCode::Char('c'), modifiers: KeyModifiers::NONE},
            add_remote: KeyEvent { code: KeyCode::Char('a'), modifiers: KeyModifiers::NONE},
            remove_remote: KeyEvent { code: KeyCode::Char('D'), modifiers: KeyModifiers::SHIFT},
