...
pub struct KeysList {
	...
	pub vim_like_move_up: GituiKeyEvent,
	pub move_down: GituiKeyEvent,
	pub vim_like_move_down: GituiKeyEvent,
...
impl Default for KeysList {
	fn default() -> Self {
		Self {
			...
			vim_like_move_up: GituiKeyEvent::new(KeyCode::Char('k'),  KeyModifiers::empty()),
			move_down: GituiKeyEvent::new(KeyCode::Down,  KeyModifiers::empty()),
			vim_like_move_down: GituiKeyEvent::new(KeyCode::Char('j'),  KeyModifiers::empty()),
