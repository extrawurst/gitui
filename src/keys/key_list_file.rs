...
pub struct KeysListFile {
    ...
    pub show_find_commit_text_input: Option<GituiKeyEvent>,
...
impl KeysListFile {
	...
	pub fn get_list(self) -> KeysList {
		...
		KeysList {
			...
			show_find_commit_text_input: self.show_find_commit_text_input.unwrap_or(default.show_find_commit_text_input),
